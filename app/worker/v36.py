"""Plane Alerts v4.2 priority-aware shared ADS-B scheduling.

v4.2 keeps the proven shared-provider polling architecture while adding the
...
async def _record_v36_metrics(
    *,
    ...
    try:
        ...
        logger.debug("Unable to persist v4.2 polling metrics", exc_info=True)
...
async def run_monitor_cycle_v36() -> None:
    try:
        ...
        logger.exception("Plane Alerts v4.2 monitor cycle failed unexpectedly")
